...
// Stats & Status Components
export { VetScheduleStats } from "./VetScheduleStats";
export { VetScheduleStatusLegend } from "./VetScheduleStatusLegend";
export { VetScheduleUpcoming } from "./VetScheduleUpcoming";

// Re-export all as named exports for consistency
export * from "./VetScheduleCalendar";
...
export * from "./VetScheduleUpcoming";
