...
import { mapStatus } from "../utils/map-slot.utils";
import { vaccinationUtils } from "../utils/vaccination.utils";
...
export function VetSelection({
  ...
  const slot = vaccinationUtils.extractSlotFromAppointmentDate(appointmentDate);
