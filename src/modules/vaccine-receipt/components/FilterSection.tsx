...
import { VACCINE_RECEIPT_MESSAGES } from "../constants";
          ...
          <div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-end">
            <div className="max-w-lg flex-1">
              ...
              <div className="group relative">
                ...
                <input
                  type="text"
                  placeholder={VACCINE_RECEIPT_MESSAGES.SEARCH_PLACEHOLDER}
            ...
            <div className="flex gap-3">
              <Button
                ...
                className="bg-primary hover:bg-primary/90 flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-medium text-white shadow-lg transition-all duration-300 hover:shadow-xl"
              >
